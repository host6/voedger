...
func New(vvmCtx context.Context, federationURL func() *url.URL, adminPortGetter func() int, policyForWithRetry PolicyForWithRetry) (federation IFederation, cleanup func()) {
